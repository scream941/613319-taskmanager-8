...
function createTask() {
  ...
  task.classList.add('card--blue');
  task.innerHTML = `<form class="card__form" method="get">
  ...
  boardOfTasks.appendChild(task);
}


function createTasks() {
  boardOfTasks.innerHTML = '';
  for(let i = 1; i < Math.round(Math.random() * (10 - 1) + 1); i++) {
    createTask();
  }
}

filterContainer.addEventListener('change', createTasks);
